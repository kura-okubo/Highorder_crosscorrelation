...
Q = 1e0	# Attenuation term (quality factor) Q
dt = 0.01
T = 50
NumofSource = 50;
...
savefig(p_all, "/Users/kurama/Documents/kurama/research/Highorder_crosscorrelation/code/cross-correlation_exercise/exercise1.png") 
...
#plot stack
signal_magnification_stack = 1e7
p_stack = plot(signal_magnification_stack.*real.(cc1_12_stack), t_cc, xlabel = "", 
    ylabel = "Lag time [s]",
...
savefig("/Users/kurama/Documents/kurama/research/Highorder_crosscorrelation/code/cross-correlation_exercise/exercise2.png") 
...
#plot stack
signal_magnification_stack = 1e1
p_stack = plot(signal_magnification_stack.*real.(cc1_31_stack), t_cc, line=(:red, 1, :solid),
	xlabel = "", 
    ylabel = "Lag time [s]",
    #xlim = (-40, 40),
    ylim = (minplotT, maxplotT),
...
p_stack = plot!(signal_magnification_stack.*real.(cc1_32_stack), t_cc, line=(:blue, 1, :solid),
	xlabel = "", 
    ylabel = "Lag time [s]",
    #xlim = (-40, 40),
    ylim = (minplotT, maxplotT),
...
layout = @layout [a{0.8w} b{0.2w}]
plot(p_all, p_stack, layout = layout, yflip = true, size = (800, 600), legend=false)
savefig("/Users/kurama/Documents/kurama/research/Highorder_crosscorrelation/code/cross-correlation_exercise/chechc1_31_32.png") 
...
#plot stack
signal_magnification_stack = 1e1
p_stack = plot(signal_magnification_stack.*real.(cc2POS_12_stack), t_cc, line=(:red, 1, :solid),
	xlabel = "", 
    ylabel = "Lag time [s]",
    #xlim = (-40, 40),
    ylim = (minplotT, maxplotT),
...
p_stack = plot!(signal_magnification_stack.*real.(cc2NEG_12_stack), t_cc, line=(:blue, 1, :solid),
	xlabel = "", 
    ylabel = "Lag time [s]",
    #xlim = (-40, 40),
    ylim = (minplotT, maxplotT),
...
p_stack_POSandNEG = plot(signal_magnification_stack.*(real.(cc2POS_12_stack) .+ real.(cc2NEG_12_stack)), t_cc, line=(:black, 1, :solid),
	xlabel = "", 
    ylabel = "Lag time [s]",
    title = "Sum up",
   	#xlim = (-40, 40),
...
savefig("/Users/kurama/Documents/kurama/research/Highorder_crosscorrelation/code/cross-correlation_exercise/C2_12_POS.png") 
