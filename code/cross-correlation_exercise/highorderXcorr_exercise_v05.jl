...
using Plots, FFTW, LinearAlgebra, Random
...
Figdir = "/Users/kurama/Documents/kurama/research/Highorder_crosscorrelation/code/fig_withsourcenoise/"
Filetype = "pdf"
#------------------------------------------------#
...
savefig(Figdir*"geom_source_and_receiver."*Filetype) 
